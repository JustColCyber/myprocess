...
Filter in specific response code with -mc

fuf -w /usr/share/wordlists/seclists/Discovery/DNS/subdomains-top1million-5000.txt:FUZZ -u http://wingdata.htb -H "Host: FUZZ.example.com" -mc 200
